<div>
<img src="vlan.png" alt="VLAN Diagram" style="width:120%; height:auto;"/>
</div>
وصف المشروع:
...
القسم الأول: لون الأبيض  ذكاء اصطناعي (AI) – عدد الأجهزة: 23 جهاز.

القسم الثاني: تقنية المعلومات لون الاخضر   (IT) – عدد الأجهزة: 24 جهاز.

القسم الثالث: قسم المهندسين (D) لون الاصفر – عدد الأجهزة: 24 جهاز.
